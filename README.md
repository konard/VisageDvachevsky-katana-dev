...
<!-- LATEST_UPDATE_START -->
* 01.12 05:24 — core: burn heap and epoll churn from hot path (aad7b82)
<!-- LATEST_UPDATE_END -->
...
<!-- BENCH_SUMMARY_START -->
* Отчёт сгенерирован 2025-12-01 02:13:34.
* Keep-alive: throughput 11720.101 req/s, p99 0.182 ms, 225736 samples.
* Масштабирование: 128 коннектов — 263939.2 req/s; 8 потоков — 149090.5 req/s.
* Устойчивость: sustained 40076.136 req/s, всего 200390 requests.
<!-- BENCH_SUMMARY_END -->
