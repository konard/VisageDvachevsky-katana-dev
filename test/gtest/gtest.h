...
inline int RUN_ALL_TESTS() {
    ...
    for (const auto& info : tests) {
        ...
        try {
            ...
            internal::report_failure(true, "Unhandled exception", __FILE__, __LINE__, false, ex.what());
        } catch (...) {
            internal::report_failure(true, "Unhandled exception", __FILE__, __LINE__, false, "unknown");
        }
...
#define EXPECT_TRUE(condition) \
    do { \
        ...
        ::testing::internal::check_condition(static_cast<bool>(gtest_cond), #condition, __FILE__, __LINE__, false); \
    } while (0)
...
#define ASSERT_TRUE(condition) \
    do { \
        auto&& gtest_cond = (condition); \
        if (::testing::internal::check_condition(static_cast<bool>(gtest_cond), #condition, __FILE__, __LINE__, true)) { \
            return; \
        } \
    } while (0)
...
#define EXPECT_EQ(val1, val2) \
    do { \
        ...
        ::testing::internal::compare_equal(gtest_lhs, gtest_rhs, #val1 " == " #val2, __FILE__, __LINE__, false); \
    } while (0)
...
#define ASSERT_EQ(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        if (::testing::internal::compare_equal(gtest_lhs, gtest_rhs, #val1 " == " #val2, __FILE__, __LINE__, true)) { \
            return; \
        } \
    } while (0)
...
#define EXPECT_NE(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        ::testing::internal::compare_not_equal(gtest_lhs, gtest_rhs, #val1 " != " #val2, __FILE__, __LINE__, false); \
    } while (0)
...
#define ASSERT_NE(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        if (::testing::internal::compare_not_equal(gtest_lhs, gtest_rhs, #val1 " != " #val2, __FILE__, __LINE__, true)) { \
            return; \
        } \
    } while (0)
...
#define EXPECT_LT(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        ::testing::internal::compare_less(gtest_lhs, gtest_rhs, #val1 " < " #val2, __FILE__, __LINE__, false); \
    } while (0)
...
#define ASSERT_LT(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        if (::testing::internal::compare_less(gtest_lhs, gtest_rhs, #val1 " < " #val2, __FILE__, __LINE__, true)) { \
            return; \
        } \
    } while (0)
...
#define EXPECT_LE(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        ::testing::internal::compare_less_equal(gtest_lhs, gtest_rhs, #val1 " <= " #val2, __FILE__, __LINE__, false); \
    } while (0)
...
#define ASSERT_LE(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        if (::testing::internal::compare_less_equal(gtest_lhs, gtest_rhs, #val1 " <= " #val2, __FILE__, __LINE__, true)) { \
            return; \
        } \
    } while (0)
...
#define EXPECT_GT(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        ::testing::internal::compare_greater(gtest_lhs, gtest_rhs, #val1 " > " #val2, __FILE__, __LINE__, false); \
    } while (0)
...
#define ASSERT_GT(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        if (::testing::internal::compare_greater(gtest_lhs, gtest_rhs, #val1 " > " #val2, __FILE__, __LINE__, true)) { \
            return; \
        } \
    } while (0)
...
#define EXPECT_GE(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        ::testing::internal::compare_greater_equal(gtest_lhs, gtest_rhs, #val1 " >= " #val2, __FILE__, __LINE__, false); \
    } while (0)
...
#define ASSERT_GE(val1, val2) \
    do { \
        const auto& gtest_lhs = (val1); \
        const auto& gtest_rhs = (val2); \
        if (::testing::internal::compare_greater_equal(gtest_lhs, gtest_rhs, #val1 " >= " #val2, __FILE__, __LINE__, true)) { \
            return; \
        } \
    } while (0)
...
#define EXPECT_NO_THROW(statement) \
    do { \
        try { \
            ...
            ::testing::internal::report_failure(true, "EXPECT_NO_THROW(" #statement ")", __FILE__, __LINE__, false, ex.what()); \
        } catch (...) { \
            ::testing::internal::report_failure(true, "EXPECT_NO_THROW(" #statement ")", __FILE__, __LINE__, false, "non-std exception"); \
        } \
    } while (0)
...
#define ASSERT_NO_THROW(statement) \
    do { \
        try { \
            ...
            if (::testing::internal::report_failure(true, "ASSERT_NO_THROW(" #statement ")", __FILE__, __LINE__, true, ex.what())) { \
                return; \
            } \
        } catch (...) { \
            if (::testing::internal::report_failure(true, "ASSERT_NO_THROW(" #statement ")", __FILE__, __LINE__, true, "non-std exception")) { \
                return; \
            } \
        } \
    } while (0)
