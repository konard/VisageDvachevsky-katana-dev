...
<!-- LATEST_UPDATE_START -->
* 25.11 06:41 — Merge pull request #83 from KATANA-Framework/ebashy (c6682ee)
<!-- LATEST_UPDATE_END -->
...
<!-- BENCH_SUMMARY_START -->
* Отчёт сгенерирован 2025-11-25 02:59:01.
* Keep-alive: throughput 12114.369 req/s, p99 0.152 ms, 371463 samples.
* Масштабирование: 128 коннектов — 275043.6 req/s; 8 потоков — 169154.5 req/s.
* Устойчивость: sustained 42504.563 req/s, всего 212535 requests.
<!-- BENCH_SUMMARY_END -->
